...
public class DateTimeUtil {
	...
	public static String date8Yesterday(){
		return date8(DateTime.now().minusDays(1));
	}
	
	public static String date4LastYear(){
		return DateTimeFormat.forPattern("yyyy").print(DateTime.now().minusYears(1));
	}
